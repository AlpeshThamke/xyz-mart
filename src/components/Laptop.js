...
function Laptop(props){
    ...
    return(
        ...
        <Typography variant='h4' style={{fontFamily:"Poppins",fontSize:30,background:'red',color:"white",width:'40%',marginBottom:20,border:'1px solid red'}}>Top Laptop Brands at your doorstep</Typography>
        ...
        <Grid container justifyContent="center" spacing={2}>
            {LaptopData.map((each) =>{
                ...
                return(
                    <Grid key={title} item>
                    <Paper sx={{height: 510,width: 600}} style={{background:"#f0f0f0",border:'1px solid black'}}>
                    <div>
                        <img style={{width:595,height:360}} src={img} alt={title}/>
                        ...
                        <Button style={{textTransform:"none",fontFamily:'Poppins',fontSize:20,marginLeft:'35%'}} variant="contained" onClick={()=>setBought(true)}  endIcon={<AddShoppingCartIcon/>}>Add to Cart</Button>
                    </div>
                </Paper>
                </Grid>
                )
